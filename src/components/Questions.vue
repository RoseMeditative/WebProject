      ...
      >
        <v-card>
          <v-card-title class="purple lighten-2">
            <h2 class="display-1 white--text font-weight-light">CHOICE 1</h2>
          </v-card-title>
          <v-container>
            <v-row>
              <v-col cols="12" md="10">
                Tu preferes (blablabla) [CHANGER ICI]
              </v-col>
              <v-col
            ...
            <v-btn v-on:click="logout" rounded color="pink" dark>Choix 1</v-btn>
                    
            <v-btn v-on:click="logout" rounded color="orange" dark>Choix 2</v-btn>
